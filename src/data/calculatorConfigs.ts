...
type CalculatorConfigDraft = Omit<
  CalculatorConfig,
  "slug" | "shortDescription" | "resultInterpretation" | "safetyNote"
> &
  Partial<
    Pick<
      CalculatorConfig,
...
function withConfigDefaults(
  ...
  return {
    ...
    resultInterpretation:
      ...
      `The primary result is shown in ${primary?.unit ?? "the selected output unit"} using the formula displayed above.`,
...
function getCalculatorConfigDraft(slug: string): CalculatorConfigDraft {
    ...
    return withConfigDefaults(slug, {
      ...
      inputs: [
        ...
        },
        {
          ...
          unit: "Hz",
          defaultValue: 60,
          helperText: "Usually 50 or 60 Hz. Informational only.",
        },
        {
          id: "voltageType",
          label: "Voltage Type",
          options: [
            { value: "vll", label: "Line-to-Line" },
            { value: "vln", label: "Line-to-Neutral" },
          ],
          defaultValue: "vll",
        },
      ],
      ...
      helperText:
        "Enter your values above to instantly calculate the electrical power.",
    });
  }
  ...
  if (slug === "12v-amps-to-watts") {
    return withConfigDefaults(slug, {
      ...
      example: "5A × 12V = 60W",
      helperText:
        "Best for 12V batteries, cars, LED strips, solar systems, and low-voltage DC devices.",
      resultInterpretation: "At 12V and 5A, the load uses 60 watts.",
      safetyNote:
        "Use proper wire size and fuse protection for 12V DC circuits.",
    });
  }
  ...
  if (slug === "24v-amps-to-watts") {
    return withConfigDefaults(slug, {
      ...
      example: "5A × 24V = 120W",
      helperText:
        "Best for 24V battery banks, trucks, solar inverters, and DC systems.",
      resultInterpretation: "At 24V and 5A, the load uses 120 watts.",
      safetyNote:
        "Check DC breaker, fuse, and wire ratings for 24V current draw.",
    });
  }
    ...
    return {
      ...
      inputs: [
        ...
        },
        {
          ...
          max: 1,
          step: 0.01,
          helperText: "Optional. Leave at 1.0 for most household devices.",
        },
      ],
      outputs: [
        { id: "watts", label: "Calculated Power", unit: "W" },
      ...
      helperText:
        "Designed for US outlets, small appliances, home circuits, and North American devices.",
    };
  }
  ...
  if (slug === "220v-amps-to-watts") {
    return {
      ...
      helperText:
        "Use for AC units, motors, international appliances, and high-power home devices.",
    };
  }
  ...
  if (slug === "230v-amps-to-watts") {
    return {
      ...
      helperText:
        "Standard for UK, Europe, Pakistan, India, and household mains.",
    };
  }
  ...
  if (slug === "240v-amps-to-watts") {
    return {
      ...
      helperText:
        "Perfect for dryers, EV chargers, HVAC, water heaters, and large appliances.",
    };
  }
    ...
    return {
      ...
      inputs: [
        ...
        },
        {
          id: "voltageType",
          label: "Voltage Type",
          options: [{ value: "vll", label: "Line-to-Line (Default)" }],
          defaultValue: "vll",
        },
      ],
      outputs: [
      ...
      helperText:
        "Calculates power for industrial systems, commercial motors, factory equipment, and three-phase loads.",
    };
  }
  ...
  if (slug === "ac-amps-to-watts-calculator") {
    return {
      ...
      inputs: [
        ...
        {
          id: "voltageType",
          label: "Voltage Type (For 3-Phase)",
          options: [
            { value: "vll", label: "Line-to-Line" },
            { value: "vln", label: "Line-to-Neutral" },
          ],
      ...
      example: "10A × 120V × 1.0 = 1200W",
      helperText:
        "Select Single-Phase or Three-Phase to calculate AC electrical power.",
    };
  }
  ...
  if (slug === "dc-amps-to-watts-calculator") {
    return {
      ...
      example: "5A × 12V = 60W",
      helperText:
        "Use for batteries, solar panels, DC motors, LED systems, and automotive circuits.",
    };
  }
  ...
  if (slug === "3-phase-amps-to-watts-calculator") {
    return {
      ...
      helperText:
        "Select Line-to-Line or Line-to-Neutral to calculate 3-phase power.",
    };
  }
  ...
  if (slug === "watts-to-amps-12v") {
    return {
      ...
      outputs: [{ id: "amps", label: "Calculated Current", unit: "A" }],
  ...
  if (slug === "amps-to-volt-amps") {
    return {
      ...
      helperText:
        "Calculate apparent power (VA) without needing a power factor.",
    };
  }
  ...
  if (slug === "kva-to-watts-calculator") {
    return {
      ...
      helperText:
        "Convert apparent power (kVA) to real power (Watts) using the power factor.",
    };
  }
  ...
  if (slug === "megawatts-to-amps-calculator") {
    return {
      ...
      example:
        "1MW = 1,000,000W; Amps = 1,000,000W ÷ (√3 × 480V × 0.9) = 1336A",
    ...
    return {
      ...
      inputs: [
        ...
        },
        {
          id: "voltageType",
          label: "Voltage Type",
          options: [{ value: "vll", label: "Line-to-Line" }],
          defaultValue: "vll",
          helperText: "Used only when three-phase is selected.",
        },
      ],
      outputs: [
    ...
    return {
      ...
      inputs: [
        ...
        },
        {
          ...
          label: "Voltage",
          options: [
            { value: 120, label: "120V Level 1" },
            { value: 240, label: "240V Level 2" },
    ...
    return {
      ...
      inputs: [
        ...
        },
        {
          ...
          max: 100,
          step: 1,
          helperText: "Optional output estimate.",
        },
        {
          id: "voltageType",
          label: "Voltage Type",
          options: [{ value: "vll", label: "Line-to-Line" }],
          defaultValue: "vll",
          helperText: "Used only for three-phase motors.",
        },
      ],
      outputs: [
      ...
      helperText:
        "Estimate motor input watts and optional shaft-output watts from nameplate current.",
    };
  }
    ...
    return {
      ...
      inputs: [
        ...
        },
        {
          ...
          options: [{ value: "vll", label: "Line-to-Line" }],
          defaultValue: "vll",
          helperText: "Use line-to-line voltage for most three-phase motors.",
        },
      ],
      outputs: [
        { id: "watts", label: "Input Watts", unit: "W" },
      ...
      helperText:
        "Use this for electric motor nameplates where power factor and efficiency are available.",
    };
  }
    ...
    return {
      ...
      inputs: [
        ...
        },
        {
          ...
          max: 1,
          step: 0.01,
          helperText: "Optional. Leave near 0.9 if unknown.",
        },
        {
          id: "hours",
          label: "Compressor Hours per Day",
          unit: "hrs",
          defaultValue: 8,
          helperText: "Optional runtime estimate.",
        },
      ],
      outputs: [
        { id: "watts", label: "Running Watts", unit: "W" },
      ...
      helperText:
        "Estimate refrigerator running watts and daily kWh from measured or nameplate current.",
    };
  }
  ...
  if (slug === "pool-pump-amps-to-watts") {
    return {
      ...
      inputs: [
        ...
        {
          id: "hours",
          label: "Pump Hours per Day",
          unit: "hrs",
          defaultValue: 6,
          helperText: "Optional daily runtime.",
        },
      ],
      outputs: [
        { id: "watts", label: "Running Watts", unit: "W" },
      ...
      helperText:
        "Estimate pool pump running watts and daily energy for single-speed or variable-speed schedules.",
    };
  }
  ...
  if (slug === "microwave-amps-to-watts") {
    return {
      ...
      outputs: [{ id: "watts", label: "Approximate Watts", unit: "W" }],
      formulaLabel: "Watts = A × V",
  ...
  if (slug === "solar-watts-to-amps-calculator") {
    return {
      ...
      resultInterpretation:
        "Use the result as a planning current before controller and wiring derating.",
    };
  }
  ...
  if (slug === "led-watts-to-amps-calculator") {
    return {
      ...
      example: "60W ÷ 12V = 5A",
      helperText:
        "Size LED power supplies and low-voltage wiring from total LED watts.",
      resultInterpretation:
        "Choose a power supply with current headroom above the calculated draw.",
    };
  }
  ...
  if (slug === "speaker-amp-power-calculator") {
    return {
      ...
      helperText:
        "Estimate amplifier input power from current draw and supply voltage.",
      resultInterpretation:
        "Audio output watts are lower than input watts after amplifier efficiency losses.",
    };
  }
    ...
    return {
      ...
      inputs: [
        ...
        },
        {
          ...
          defaultValue: "vll",
          helperText: "Used only for three-phase AC.",
        },
      ],
      outputs: [
        { id: "watts", label: "Calculated Power", unit: "W" },
      ...
      helperText:
        "Use any custom voltage for DC, single-phase AC, or three-phase AC calculations.",
    };
  }
  ...
  if (slug === "power-factor") {
    return {
      ...
      resultInterpretation:
        "Power factor shows how much apparent power becomes usable real power.",
    };
  }
  ...
  if (slug === "wire-gauge-calculator") {
    return {
      ...
      formulas: {
        ...
        "ac3-vll":
          "Selects smallest AWG meeting ampacity and three-phase voltage drop limits.",
      },
