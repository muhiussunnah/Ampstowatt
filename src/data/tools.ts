...
export const tools: Tool[] = [
  { slug: '12v-amps-to-watts-calculator', title: '12V Amps to Watts Calculator — DC Battery & Solar | Ampstowatt', h1Title: '12V Amps to Watts Calculator', shortTitle: '12V Calculator', description: 'Convert 12V amps to watts instantly. Formula: W = A × 12V. For batteries, RV solar, and automotive loads. Includes DC wiring table.', kind: 'amps-to-watts', defaultVoltage: 12, defaultPhase: 'dc', eyebrow: 'Low-voltage DC', formula: 'Watts = Amps x 12V', highlights: ['Battery and vehicle systems', 'DC mode by default', 'Instant wattage and kW output'] },
  { slug: '120v-amps-to-watts-calculator', title: '120V Amps to Watts Calculator — US Household Circuits | Ampstowatt', h1Title: '120V Amps to Watts Calculator', shortTitle: '120V Calculator', description: 'Convert 120V amps to watts for US household outlets. W = A × 120. Includes 15A, 20A, and 30A breaker planning limits.', kind: 'amps-to-watts', defaultVoltage: 120, defaultPhase: 'ac1', eyebrow: 'North American circuits', formula: 'Watts = Amps x 120V x PF', highlights: ['15A and 20A planning', 'Power factor support', 'Continuous-load guidance'] },
  { slug: '220v-amps-to-watts-calculator', title: '220V Amps to Watts Calculator — Appliances & Mains | Ampstowatt', h1Title: '220V Amps to Watts Calculator', shortTitle: '220V Calculator', description: 'Convert 220V amps to watts for appliances and international mains. W = A × 220. Includes AC single-phase and load planning.', kind: 'amps-to-watts', defaultVoltage: 220, defaultPhase: 'ac1', eyebrow: 'High-voltage appliances', formula: 'Watts = Amps x 220V x PF', highlights: ['Appliance load planning', 'AC power factor option', 'kW conversion included'] },
  { slug: '230v-amps-to-watts-calculator', title: '230V Amps to Watts Calculator — UK & EU Mains | Ampstowatt', h1Title: '230V Amps to Watts Calculator', shortTitle: '230V Calculator', description: 'Convert 230V amps to watts for UK and EU circuits. W = A × 230 × PF. Includes BS 7671 and IEC load planning examples.', kind: 'amps-to-watts', defaultVoltage: 230, defaultPhase: 'ac1', eyebrow: 'UK and EU mains', formula: 'Watts = Amps x 230V x PF', highlights: ['230V preset', 'Single-phase AC mode', 'Professional result summary'] },
  { slug: '240v-amps-to-watts-calculator', title: '240V Amps to Watts Calculator — Dryers, EVs & HVAC | Ampstowatt', h1Title: '240V Amps to Watts Calculator', shortTitle: '240V Calculator', description: 'Convert 240V amps to watts for dryers, EV chargers, and HVAC. W = A × 240. Includes NEC 80% continuous load safety limits.', kind: 'amps-to-watts', defaultVoltage: 240, defaultPhase: 'ac1', eyebrow: '240V residential loads', formula: 'Watts = Amps x 240V x PF', highlights: ['EV and HVAC friendly', '80% continuous-load note', 'Watts and kW output'] },
  ...
  { slug: 'single-phase-amps-to-watts-calculator', title: 'Single-Phase Amps to Watts Calculator | Ampstowatt', h1Title: 'Single-Phase Amps to Watts Calculator', shortTitle: 'Single Phase', description: 'Calculate single-phase AC watts from amps, voltage, and power factor. Formula: W = A × V × PF. For 120V, 240V, and 230V circuits.', kind: 'amps-to-watts', defaultVoltage: 230, defaultPhase: 'ac1', eyebrow: 'Single-phase AC', formula: 'Watts = Amps x Volts x PF', highlights: ['Residential and light commercial', 'PF-aware', 'kW result included'] },
